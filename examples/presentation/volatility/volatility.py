...
if __name__ == '__main__':
    ...
    chart.add_data(x=d1.index, y=d1['y'], label="Implizite Volatilität S&P 500", y_axis=0)
    chart.add_data(x=d2.index, y=d2['y'], label="Implizite Volatilität Eurostoxx 50", y_axis=0)
    ...
    chart = TimeSeriesChart(title="Implizite Volatilität US Staatsanleihen", num_y_axes=1)

    chart.configure_y_axis(axis_index=0, label="%", y_lim=(50, 210))
