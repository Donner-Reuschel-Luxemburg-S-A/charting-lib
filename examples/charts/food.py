...
if __name__ == '__main__':
    ...
    d1, t1 = blp.get_series(series_id='GMFDDSE3 Index', observation_start="19920331")
    d2, t2 = blp.get_series(series_id='GRCPH11Y Index', observation_start="19920331")
    ...
    chart.add_series(x=d1.index, y=d1['y'], label=t1, y_axis_index=1)
    chart.add_series(x=d2.index, y=d2['y'], label=t2, y_axis_index=0)
