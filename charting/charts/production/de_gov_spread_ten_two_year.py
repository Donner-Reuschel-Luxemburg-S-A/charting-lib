...
def main(**kwargs):
    ...
    title = "Germany Government Bonds Spread 2-10-Year"
    metadata = Metadata(title=title, region=Region.DE, category=Category.RATES)
    chart = Chart(title=title, metadata=metadata, filename="de_gov_spread_10y_2y", language=kwargs.get('language', 'en'))
