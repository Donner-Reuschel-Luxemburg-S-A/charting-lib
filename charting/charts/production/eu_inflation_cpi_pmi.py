...
def main():
    ...
    d2, t2 = estat.get_data(flow_ref="ICP", key="M.U2.N.XEF000.4.INX", parameters={'startPeriod': '2006-01'})
    ...
    chart.add_series(x=d2.index, y=d2['y'], label="Eurozone Harmonized CPI ex. Energy, Food, Alcohol and Tabacco", transformer=Pct(periods=12))
