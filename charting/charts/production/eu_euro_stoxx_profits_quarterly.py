...
def main(**kwargs):
    ...
    df1, t1 = blp.get_series(series_id='SX5E Index', field="RR906",
    ...
    chart = Chart(title=title, filename="eu_sx5e_profits_quarterly", metadata=metadata, num_y_axis=2, language=kwargs.get('language', 'en'))
