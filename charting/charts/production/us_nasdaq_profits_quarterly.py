...
def main(**kwargs):
    ...
    df1, t1 = blp.get_series(series_id='NDX Index', field="RR906",
    ...
    chart = Chart(title=title, filename="us_nasdaq_100_quarterly", metadata=metadata, num_y_axis=2, language=kwargs.get('language', 'en'))
