...
def main():
    ...
    chart = Chart(title=title, metadata=metadata, filename="eu_sx5e_profit_margin_fifty_year.png")

    chart.configure_y_axis(y_axis_index=0, label="%", minor_locator=MultipleLocator(0.5),
