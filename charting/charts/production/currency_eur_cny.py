...
def main(**kwargs):
    ...
    source = Ecb()
    df1, t1 = source.get_data(flow_ref="EXR", key='D.CNY.EUR.SP00.A',
    ...
    chart = Chart(title=title, metadata=metadata, filename="currency_eur_cny", language=kwargs.get('language', 'en'))
