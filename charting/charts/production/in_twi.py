...
def main():
    blp = BloombergSource()
    df, t = blp.get_series(series_id='TWI IRSP Index', observation_start='20170101')
    ...
    chart.configure_y_axis(y_axis_index=0, label="Index", minor_locator=MultipleLocator(5),
