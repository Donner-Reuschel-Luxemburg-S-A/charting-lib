...
def main(**kwargs):
    ...
    df1, t1 = blp.get_series(series_id='MXEF Index', field="RR836", observation_start=observation_start.strftime("%Y%m%d"),
    ...
    chart = Chart(title=title, metadata=metadata, filename="eu_mxef_profit_margin.png")
