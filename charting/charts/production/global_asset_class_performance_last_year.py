...
def main():
    ...
    stock_dfs = [blp.get_series(series_id=idx, observation_start="20230101", observation_end="20231231") for idx in stock_indices]
    ...
    fi_dfs = [blp.get_series(series_id=idx, observation_start="20230101", observation_end="20231231") for idx in
                 fi_indices]
    ...
    title = f"Global Asset Class Performance - 1 Year (01.01.2023 - 31.12.2023)"
