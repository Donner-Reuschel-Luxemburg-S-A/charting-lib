...
def main(**kwargs):
    ...
    blp = BloombergSource()
    df, t = blp.get_series(series_id='TWI ADSP Index', observation_start=observation_start.strftime("%Y%m%d"),
    ...
    chart = Chart(title=title, metadata=metadata, filename="au_twi", language=kwargs.get('language', 'en'))
