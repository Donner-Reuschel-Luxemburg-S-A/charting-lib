...
def main():
    ...
    chart = Chart(title=title, filename="us_indu_profits_quarterly.png", metadata=metadata, num_y_axis=2)

    chart.configure_y_axis(y_axis_index=0, label="USD $", minor_locator=MultipleLocator(50), major_locator=MultipleLocator(100))
