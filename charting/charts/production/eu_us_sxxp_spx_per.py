...
def main(**kwargs):
    ...
    df1, t1 = blp.get_series(series_id='SXXP Index', field="RR900", observation_start=observation_start.strftime("%Y%m%d"),
                             observation_end=observation_end.strftime("%Y%m%d"))
    df2, t2 = blp.get_series(series_id='SPX Index', field="RR900", observation_start=observation_start.strftime("%Y%m%d"),
                             observation_end=observation_end.strftime("%Y%m%d"))
    ...
    chart = Chart(title=title, metadata=metadata, filename="eu_us_sxxp_spx_per.png")
