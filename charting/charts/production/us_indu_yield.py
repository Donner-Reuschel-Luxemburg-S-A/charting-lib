...
def main(**kwargs):
    ...
    df1, t1 = blp.get_series(series_id='INDU Index', field="px_close_1d",
    ...
    chart = Chart(title=title, metadata=metadata, filename="us_indu_yield", language=kwargs.get('language', 'en'))
