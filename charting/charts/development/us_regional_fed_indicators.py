...
def main():
    ...
    richmond_business_outlook_df, richmond_business_outlook_title = blp.get_series(series_id="RCSSCLBC Index", observation_start=start_time)
    ...
    chart.add_series(philly_business_outlook_df.index, philly_business_outlook_df['y'], label=philly_business_outlook_title)
    ...
    chart.add_series(richmond_business_outlook_df.index, richmond_business_outlook_df['y'], label=richmond_business_outlook_title)
