...
def main(**kwargs):
    ...
    chart = Chart(title=title, filename="us_wholesale_sales_mom_6", language=kwargs.get('language', 'en'))
    ...
    chart = Chart(title=title, filename="us_wholesale_sales_mom", metadata=metadata, language=kwargs.get('language', 'en'))
    chart.configure_x_axis(minor_locator=mdates.YearLocator(base=1), major_locator=mdates.YearLocator(base=5))
    ...
    chart = Chart(title=title, filename="us_wholesale_sales_yoy", metadata=metadata, language=kwargs.get('language', 'en'))
    chart.configure_x_axis(minor_locator=mdates.YearLocator(base=1), major_locator=mdates.YearLocator(base=5))
    chart.configure_y_axis(minor_locator=MultipleLocator(1), major_locator=MultipleLocator(5),
                           label="Percentage Points")
