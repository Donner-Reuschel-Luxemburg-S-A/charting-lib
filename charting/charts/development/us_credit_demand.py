...
def main():
    ...
    start_time="19290101"
    credit_demand_small_df, credit_demand_small_title = blp.get_series(series_id="SLDEDEMS Index", observation_start=start_time)
    credit_demand_large_df, credit_demand_large_title = blp.get_series(series_id="SLDEDEMD Index", observation_start=start_time)
