...
#,  metadata=metadata
    ...
    chart = Chart(title=title, num_rows=2,num_y_axis=2, filename=__name__ + ".png")
    ...
    chart.add_series(x=common_index, y=(df2.loc[common_index]-df.loc[common_index])['y'], row_index=1,y_axis_index=0, label=title)
