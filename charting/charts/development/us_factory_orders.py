...
def main(**kwargs):
    ...
    chart = Chart(title=title, filename="us_factory_orders_mom_6", metadata=metadata, language=kwargs.get('language', 'en'))
    ...
    chart = Chart(title=title, filename="us_factory_orders_mom_12", metadata=metadata, language=kwargs.get('language', 'en'))
    chart.configure_x_axis(minor_locator=mdates.YearLocator(base=1), major_locator=mdates.YearLocator(base=2))
    chart.configure_y_axis(minor_locator=MultipleLocator(1), major_locator=MultipleLocator(10),
                           label="Percentage Points")
    ...
    chart = Chart(title=title, filename="us_factory_orders_yoy", metadata=metadata, language=kwargs.get('language', 'en'))
    chart.configure_x_axis(minor_locator=mdates.YearLocator(base=1), major_locator=mdates.YearLocator(base=2))
    chart.configure_y_axis(minor_locator=MultipleLocator(1), major_locator=MultipleLocator(10),
                           label="Percentage Points")
