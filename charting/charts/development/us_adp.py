...
def main(**kwargs):
    ...
    chart = Chart(title=title, filename="us_adp_mom_6.jpeg", metadata=metadata)
    ...
    chart = Chart(title=title, filename="us_adp_mom.jpeg", metadata=metadata)
    chart.configure_x_axis(minor_locator=mdates.YearLocator(base=1), major_locator=mdates.YearLocator(base=5))
    chart.configure_y_axis(minor_locator=MultipleLocator(500), major_locator=MultipleLocator(1000), label="")
    ...
    chart = Chart(title=title, filename="us_adp_yoy.jpeg", metadata=metadata)
    chart.configure_x_axis(minor_locator=mdates.YearLocator(base=1), major_locator=mdates.YearLocator(base=5))
    chart.configure_y_axis(minor_locator=MultipleLocator(500), major_locator=MultipleLocator(1000), label="")
