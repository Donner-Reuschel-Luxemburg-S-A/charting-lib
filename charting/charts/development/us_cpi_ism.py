...
def main():
    ...
    chart.add_series(ism_manu_df.index,ism_manu_df['y'], label=ism_manu_title,y_axis_index=1,transformer=[Lag(DateOffset(months=-2))])
    ...
    chart.add_series(cpi_df.index, cpi_df['y'], label=cpi_title)
    chart.add_series(ism_serv_df.index,ism_serv_df['y'], label=ism_serv_title,y_axis_index=1,transformer=[Lag(DateOffset(months=-2))])
