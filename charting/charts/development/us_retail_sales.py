...
def main():
    ...
    retailsales_ex_auto_df, retailsales_ex_auto_title = blp.get_series(series_id="RSTAXMOM Index", observation_start=start_time)
    retailsales_ex_auto_gas_df, retailsales_ex_auto_gas_title = blp.get_series(series_id="RSTAXMOM Index", observation_start=start_time)
    ...
    chart.add_series(retailsales_df.index, retailsales_df['y']*12, label=retailsales_title, transformer=[Avg(offset=DateOffset(months=6))])
    chart.add_series(retailsales_ex_auto_df.index, retailsales_ex_auto_df['y'] * 12, label=retailsales_ex_auto_title, transformer=[Avg(offset=DateOffset(months=6))])
    chart.add_series(retailsales_ex_auto_gas_df.index, retailsales_ex_auto_gas_df['y'] * 12, label=retailsales_ex_auto_gas_title, transformer=[Avg(offset=DateOffset(months=6))])
    ...
    chart.add_series(retailsales_ex_auto_gas_df.index, retailsales_ex_auto_gas_df['z'], label=retailsales_ex_auto_gas_title)
