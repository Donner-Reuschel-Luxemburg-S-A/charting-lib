...
def main():
    ...
    stock_dfs = [blp.get_series(series_id=idx, observation_start="20230930", observation_end="20240331") for idx in stock_indices]
    ...
    cmdty_indices = ["XAG Curncy", "XAU Curncy", "CL1 Comdty", "EURUSD Curncy", "USDJPY Curncy", "EURCHF Curncy", "EURGBP Curncy"]
    cmdty_dfs = [blp.get_series(series_id=idx, observation_start="20230930", observation_end="20240331") for idx in
                 cmdty_indices]
    cmdty_names = ["Silver USD", "Gold USD", "Crude Oil WTI", "EUR/USD", "USD/JPY", "EUR/CHF", "EUR/GBP"]
    ...
    fi_dfs = [blp.get_series(series_id=idx, observation_start="20230930", observation_end="20240331") for idx in
                 fi_indices]
    ...
    chart = Chart(title=title, filename="aaaaas.png", num_rows=3)
    ...
    chart.configure_x_axis(label="Percentage Points", minor_locator=MultipleLocator(1),
