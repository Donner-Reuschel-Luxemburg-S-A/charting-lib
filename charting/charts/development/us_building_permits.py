...
def main(**kwargs):
    ...
    chart = Chart(title=title, filename="us_building_permits_mom_6.jpeg", metadata=metadata)
    ...
    chart = Chart(title=title, filename="us_building_permits_12.jpeg", metadata=metadata)
    chart.configure_x_axis(minor_locator=mdates.YearLocator(base=1), major_locator=mdates.YearLocator(base=5))
    chart.configure_y_axis(minor_locator=MultipleLocator(2), major_locator=MultipleLocator(10),
                           label="Percentage Points")
    ...
    chart = Chart(title=title, filename="us_building_permits_yoy.jpeg", metadata=metadata)
    chart.configure_x_axis(minor_locator=mdates.YearLocator(base=1), major_locator=mdates.YearLocator(base=5))
    chart.configure_y_axis(minor_locator=MultipleLocator(2), major_locator=MultipleLocator(10),
                           label="Percentage Points")
